...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#18181b]/95 text-white border-b border-zinc-800 backdrop-blur-md shadow-lg">
      <div className="bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-500 text-zinc-950 font-black text-xs py-1.5 px-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={onOpenCart}
              className="relative flex items-center gap-2 bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-600 hover:to-amber-600 text-zinc-950 font-black shadow-lg shadow-yellow-500/20 px-4 py-2.5 rounded-xl transition transform active:scale-95"
            >
