...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="group bg-[#18181b] border border-zinc-800 hover:border-yellow-500 shadow-lg hover:shadow-yellow-500/10 rounded-2xl overflow-hidden transition-all duration-300 flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          <span className="text-[11px] text-yellow-400 font-bold mb-1 block">{product.category}</span>
          <h3
        ...
        <div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-600 hover:to-amber-600 text-zinc-950 font-black shadow-lg shadow-yellow-500/20 py-2.5 px-3 rounded-xl transition text-xs font-bold"
          >
