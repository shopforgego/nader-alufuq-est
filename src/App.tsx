        ...
        {filteredProducts.length === 0 ? (
          <div className="bg-black/5 border border-current/10 rounded-3xl p-12 text-center">
            ...
            <button
              ...
              className="bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-600 hover:to-amber-600 text-zinc-950 font-black shadow-lg shadow-yellow-500/20 text-xs px-4 py-2 rounded-xl"
            >
              إعادة تعيين البحث
            </button>
          </div>
